...
lmfits %>%
  ...
  geom_line(data=CH_ks_umax_pred, aes(x=N.Treatment, y=.fitted)) +
...
write_csv(as.data.frame(CH_unique_boots), "data-processed/CH_unique_boots.csv")
