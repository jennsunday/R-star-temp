...
#add nitrate data
#
unique(nitratedata10$date_N_assay)
...
with(Rstar_expt10, plot((biovolume)~start_time, type="n", ylab="", xlab="", ylim=c(0, 2E8)))
...
with(Rstar_expt16, plot((biovolume)~start_time, ylab="", xlab="", type="n", ylim=c(0, 2E8)))
...
with(Rstar_expt25, plot((biovolume)~start_time, ylab="", xlab="", type="n", ylim=c(0, 2E8)))
...
with(Rstar_expt30, plot((biovolume)~start_time, ylab="", xlab="", type="n", ylim=c(0, 2E8)))
...
with(Rstars, plot(nitrate~temp, col=as.numeric(as.factor(species))))
